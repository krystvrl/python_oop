...
* **Обработка исключений**: создана изолированная иерархия собственных исключений (`BankAppException` и 6 наследников) для безопасной обработки ошибок предметной области, чтобы программа не падала ("крашилась") при ошибках.
...
* **Типизация**: внедрены строгие аннотации типов (Type Hints) для всех методов, а также написано полноценное документирование через `docstring`.
